...
function NumberInputField({
  ...
  return (
    <NumberInputPrimitive.Input
      ...
      className={cn(
        "flex h-full w-full min-w-0 border border-input bg-transparent px-3 py-1 text-center text-base tabular-nums transition-[color,box-shadow] ease-out outline-none selection:bg-primary selection:text-primary-foreground placeholder:text-muted-foreground md:text-sm dark:bg-input/30 data-disabled:pointer-events-none data-disabled:opacity-50",
