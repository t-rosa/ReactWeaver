...
export interface paths {
    ...
    "/api/weather-forecasts/bulk-delete": {
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["RemoveWeatherForecastsRequest"];
                    "text/json": components["schemas"]["RemoveWeatherForecastsRequest"];
                    "application/*+json": components["schemas"]["RemoveWeatherForecastsRequest"];
                };
            };
            responses: {
